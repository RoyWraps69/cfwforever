...
(function(){
  ...
  bar.innerHTML='<a href="tel:+13125971286" style="flex:1;max-width:180px;background:#F5C518;color:#000;font-family:\'Barlow Condensed\',sans-serif;font-size:1rem;font-weight:900;letter-spacing:.05em;text-transform:uppercase;text-decoration:none;padding:11px 16px;border-radius:8px;text-align:center;display:flex;align-items:center;justify-content:center;gap:6px">\uD83D\uDCDE Call Now</a><a href="/estimate/" style="flex:1;max-width:180px;background:transparent;color:#F5C518;font-family:\'Barlow Condensed\',sans-serif;font-size:1rem;font-weight:900;letter-spacing:.05em;text-transform:uppercase;text-decoration:none;padding:11px 16px;border-radius:8px;text-align:center;border:1px solid rgba(245,197,24,.5);display:flex;align-items:center;justify-content:center;gap:6px">Free Estimate</a>';
