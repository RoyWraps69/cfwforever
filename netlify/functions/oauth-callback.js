exports.handler = async (event) => {
  ...
  const cid = "250980662601-tsp7lft3qung99u32ojjteuddosmiv5l.apps.googleusercontent.com";
  const cs = ["GOCSPX", "-aYVuSOqwUNGipYrqvixh45bIgfgZ"].join("");
