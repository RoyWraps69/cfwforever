...
const PAGES = [
  ...
  { slug: 'removal', url: 'removal', h1: 'Wrap Removal Chicago', desc: 'Professional vehicle wrap removal in Chicago. Safe removal preserving factory paint. Fleet and individual vehicles. Free estimates.', title: 'Wrap Removal Chicago | Chicago Fleet Wraps', category: 'Services', keywords: 'wrap removal Chicago, vehicle wrap removal, vinyl removal, fleet wrap removal, wrap removal cost', content: 'Professional vehicle wrap removal services in Chicago. Safe heat-gun removal preserving factory paint. Fleet and individual vehicles. Adhesive residue cleaning included. Free estimates.' },
  ...
  // === Industry Pages ===
  { slug: 'hvac', url: 'hvac', h1: 'HVAC Fleet Wraps Chicago', desc: 'HVAC fleet vehicle wraps in Chicago. Cargo vans, trucks, sprinters. Generate 30,000+ daily impressions. Free pickup & fleet discounts.', title: 'HVAC Fleet Wraps Chicago | Chicago Fleet Wraps', category: 'Industries', keywords: 'HVAC fleet wraps, HVAC van wraps Chicago, HVAC truck wraps, heating cooling vehicle wraps, HVAC branding', content: 'HVAC fleet vehicle wraps generating 30,000+ daily impressions per vehicle. Cargo vans, trucks, sprinters. Professional designs on exact vehicle templates. Free pickup throughout Chicagoland. Fleet discounts available.' },
  ...
  { slug: 'contractor', url: 'contractor', h1: 'General Contractor Fleet Wraps Chicago', desc: 'General contractor vehicle wraps in Chicago. Trucks, vans, and fleet vehicles. Professional branding. Free fleet pickup.', title: 'General Contractor Fleet Wraps Chicago | Chicago Fleet Wraps', category: 'Industries', keywords: 'contractor vehicle wraps Chicago, general contractor fleet wraps, construction truck wraps, contractor van graphics', content: 'General contractor vehicle wraps in Chicago. Trucks, vans, and fleet vehicles. Professional branding that generates leads on every job site and commute.' },
  { slug: 'delivery', url: 'delivery', h1: 'Delivery Fleet Wraps Chicago', desc: 'Delivery and logistics fleet wraps in Chicago. Box trucks, cargo vans, sprinters. Volume discounts. Free pickup.', title: 'Delivery Fleet Wraps Chicago | Chicago Fleet Wraps', category: 'Industries', keywords: 'delivery fleet wraps Chicago, logistics vehicle wraps, delivery van graphics, delivery truck branding', content: 'Delivery and logistics fleet wraps in Chicago. Box trucks, cargo vans, sprinters. Volume discounts for large fleets. Free pickup and delivery throughout Chicagoland.' },
  ...
  { slug: 'warranty', url: 'warranty', h1: 'Warranty Policy', desc: '2-year installation warranty covering lifting, peeling, bubbling. 5–7 year vinyl manufacturer warranty. Chicago Fleet Wraps.', title: 'Warranty Policy | Chicago Fleet Wraps', category: 'Company', keywords: 'vehicle wrap warranty, wrap guarantee, Avery Dennison warranty, 3M wrap warranty', content: '2-year workmanship warranty covering lifting, peeling, and bubbling. 5–7 year vinyl manufacturer warranty from Avery Dennison and 3M.' },
  ...
  // === Resource Pages ===
  { slug: 'roi', url: 'roi', h1: 'Fleet Wrap ROI Calculator Guide', desc: 'Calculate your fleet wrap ROI. CPM data, impression counts, and cost comparisons. Chicago Fleet Wraps.', title: 'Fleet Wrap ROI Calculator Guide | Chicago Fleet Wraps', category: 'Resources', keywords: 'fleet wrap ROI, vehicle wrap return on investment, wrap CPM, advertising ROI calculator', content: 'Calculate your fleet wrap return on investment. Vehicle wraps deliver the lowest CPM of any advertising medium at $0.04–$0.48 per thousand impressions.' },
  ...
  { slug: 'vsads', url: 'vsads', h1: 'Vehicle Wraps vs Google Ads', desc: 'Compare vehicle wraps to Google Ads, billboards, and social media. CPM, ROI, and cost analysis. Chicago Fleet Wraps.', title: 'Vehicle Wraps vs Google Ads | Chicago Fleet Wraps', category: 'Resources', keywords: 'vehicle wraps vs Google Ads, wrap vs billboard, fleet advertising comparison, best advertising for small business', content: 'Vehicle wraps vs Google Ads, billboards, and social media advertising. Side-by-side CPM, ROI, and total cost comparison over 5 years.' },
  ...
  // === Blog Posts ===
  { slug: 'post-downside-wrapping', url: 'post/what-is-the-downside-of-wrapping-a-car', h1: 'What Is the Downside of Wrapping a Car?', desc: 'An honest look at vehicle wrap trade-offs: durability, quality, surface prep, and washing restrictions. From 24+ years experience.', title: 'What Is the Downside of Wrapping a Car? | Chicago Fleet Wraps', category: 'Blog', keywords: 'downside of wrapping a car, vehicle wrap cons, wrap disadvantages, is wrapping a car worth it', content: 'An honest look at vehicle wrap downsides from 24+ years of experience. Durability limitations, quality differences between cast and calendered vinyl, surface preparation requirements, and washing restrictions.' },
