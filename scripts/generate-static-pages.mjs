...
const PAGES = [
  ...
  { slug: 'geo-palatine', url: 'palatine', ogImage: 'precision_today_sprinter.jpg', heroImage: 'small_transit_van_opt.webp', h1: 'Fleet Wraps Palatine, IL', desc: 'Fleet vehicle wraps serving Palatine, IL. Free pickup and delivery. Premium cast vinyl.', title: 'Fleet Wraps Palatine, IL | Chicago Fleet Wraps', category: 'Cities', city: 'Palatine', keywords: 'fleet wraps Palatine, vehicle wraps Palatine IL, car wraps Palatine' }, h1: 'Fleet Wraps Palatine, IL', desc: 'Fleet vehicle wraps serving Palatine, IL. Free pickup and delivery. Premium cast vinyl.', title: 'Fleet Wraps Palatine, IL | Chicago Fleet Wraps', category: 'Cities', city: 'Palatine', keywords: 'fleet wraps Palatine, vehicle wraps Palatine IL, car wraps Palatine' },
