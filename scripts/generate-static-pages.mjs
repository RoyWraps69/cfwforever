...
const PAGES = [
  ...
  { slug: 'geo-schaumburg', url: 'schaumburg', ogImage: 'cfw_van_2.webp', heroImage: 'cfw_truck_3.webp', h1: 'Fleet Wraps Schaumburg, IL', desc: 'Fleet vehicle wraps serving Schaumburg, IL. Free pickup and delivery. Premium cast vinyl. Chicago Fleet Wraps.', title: 'Fleet Wraps Schaumburg, IL | Chicago Fleet Wraps', category: 'Cities', city: 'Schaumburg', keywords: 'fleet wraps Schaumburg, vehicle wraps Schaumburg IL, car wraps Schaumburg, commercial wraps Schaumburg' },
  { slug: 'geo-naperville', url: 'naperville', ogImage: 'cfw_van_3.webp', heroImage: 'cfw_van_1.webp', h1: 'Fleet Wraps Naperville, IL', desc: 'Fleet vehicle wraps serving Naperville, IL. Free pickup and delivery. Premium cast vinyl. Chicago Fleet Wraps.', title: 'Fleet Wraps Naperville, IL | Chicago Fleet Wraps', category: 'Cities', city: 'Naperville', keywords: 'fleet wraps Naperville, vehicle wraps Naperville IL, car wraps Naperville, commercial wraps Naperville' },
  ...
  { slug: 'geo-evanston', url: 'evanston', ogImage: 'small_transit_van_opt.webp', heroImage: 'cfw_van_2.webp', h1: 'Fleet Wraps Evanston, IL', desc: 'Fleet vehicle wraps serving Evanston, IL. Free pickup and delivery. Premium cast vinyl. Chicago Fleet Wraps.', title: 'Fleet Wraps Evanston, IL | Chicago Fleet Wraps', category: 'Cities', city: 'Evanston', keywords: 'fleet wraps Evanston, vehicle wraps Evanston IL, car wraps Evanston, commercial wraps Evanston' },
  { slug: 'geo-skokie', url: 'skokie', ogImage: 'sns_roofing_truck.webp', heroImage: 'cfw_truck_1.webp', h1: 'Fleet Wraps Skokie, IL', desc: 'Fleet vehicle wraps serving Skokie, IL. Free pickup and delivery. Premium cast vinyl. Chicago Fleet Wraps.', title: 'Fleet Wraps Skokie, IL | Chicago Fleet Wraps', category: 'Cities', city: 'Skokie', keywords: 'fleet wraps Skokie, vehicle wraps Skokie IL, car wraps Skokie, commercial wraps Skokie' },
